...
const projects: ProjectCardInfo[] = [
    ...
    },
    {
        ...
        paragraphs: [
            "<div class='flex flex-row gap-x-1'><a href='https://github.com/kaismic/Hitomi-Scroll-Viewer/releases/latest'><img src='https://img.shields.io/github/release/kaismic/Hitomi-Scroll-Viewer.svg?logo=github' alt='GitHub latest release'></a><a href='https://github.com/kaismic/Hitomi-Scroll-Viewer/releases/latest'><img src='https://img.shields.io/github/downloads/kaismic/Hitomi-Scroll-Viewer/latest/total.svg?logo=github' alt='GitHub downloads count latest release'></a><a href='https://github.com/kaismic/Hitomi-Scroll-Viewer/releases'><img src='https://img.shields.io/github/downloads/kaismic/Hitomi-Scroll-Viewer/total.svg?logo=github' alt='GitHub downloads count total'></a></div>",
